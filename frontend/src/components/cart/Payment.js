        ...
        try {
            ...
            if (result.error) {
                ...
                if (result.paymentIntent.status === 'succeeded') {
                    ...
                    toast.warning('Please try again!', { position: 'bottom-center' });
                }
            }
        } catch (error) {
            // Handle errors from the server or unexpected errors
            console.error('Error processing payment:', error);
            toast.error('An error occurred while processing your payment. Please try again later.', { position: 'bottom-center' });
            document.querySelector('#pay_btn').disabled = false;
        }
    };
